...
{
	internal class ProcessorTimePerfCounterFactoryUC : IPerfCounterFactoryUC
	{
		public PerfCounterTypeUC PerfCounterType { get; } = PerfCounterTypeUC.ProcessorTime;
		public IPerfCounterUC NewPerfCounterUC(string processName = null, int? pid = null)
		=> new ProcessorTimePerfCounterUC(processName, pid)
		;
	}

	internal class ProcessorTimePerfCounterUC : IPerfCounterUC, IDisposable, IEnumerable<double>
	{
		...
		public ProcessorTimePerfCounterUC(string processName = null, int? pid = null)
		{
			...
			{
				Counter = new PerformanceCounter("Process", "% Processor Time", DiagnosticsUC.GetProcessName(), true);
				ResetCounter();
			}
