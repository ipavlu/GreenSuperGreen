...
{
	public sealed class LockUCTryEnterDelay : ATestingJob, ITestingJob
	{
		public int Delay { get; }
		public LockUCTryEnterDelay(int count, int delay) : base(count) { Delay = delay; }
	...
	public partial class UnifiedConcurrency
	{
		...
		[Test]
		public async Task LockUCTryEnterDelayTest()
		{
			using (ITestingJob job = new LockUCTryEnterDelay(10000, 15))
			{
