...
namespace UnifiedConcurrency.SynchronizationPrimitives
{
	...
	/// </summary>
	public sealed class MutexLockUCEnter : ATestingJob, ITestingJob
	{
		public MutexLockUCEnter(int count) : base(count) { }
...
#pragma warning restore 618
	...
	public partial class UnifiedConcurrency
	{
		...
		[Test]
		public async Task MutexLockUCEnterTest()
		{
			using (ITestingJob job = new MutexLockUCEnter(10000))
			{
